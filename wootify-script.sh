...
#
# Version: 4.6-RHEL (Ensured network connectivity is enabled during LEMP install)
#
# Main features:
...
EOL
    ...
    sudo -u "$site_user" "$WP_CLI_PATH" plugin install contact-form-7 woocommerce classic-editor classic-widgets wp-optimize wp-fastest-cache wp-mail-smtp redis-cache --activate --path="$webroot"
